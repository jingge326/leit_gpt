...
from libs.pypots.data.dataset_for_brits import DatasetForBRITS
from libs.pypots.data.integration import mcar, masked_fill
from libs.pypots.imputation.base import BaseNNImputer
...
class RITS(nn.Module):
    ...
    def impute(self, inputs, direction):
        ...
        for t in range(self.n_steps):
            ...
            alpha = torch.sigmoid(self.combining_weight(
                torch.cat([gamma_x, m], dim=1)))
    ...
    def forward(self, inputs, direction="forward"):
        ...
        """
        imputed_data, hidden_state, reconstruction_loss = self.impute(
            inputs, direction)
...
class _BRITS(nn.Module):
    ...
    def merge_ret(self, ret_f, ret_b):
        ...
        ret_f["imputed_data"] = (
            ret_f["imputed_data"] + ret_b["imputed_data"]) / 2
