...
from libs.pypots.data import DatasetForBRITS
from libs.pypots.imputation.brits import RITS as imputation_RITS, _BRITS as imputation_BRITS
...
class _BRITS(imputation_BRITS, nn.Module):
    def __init__(
        ...
        # create models
        self.rits_f = RITS(n_steps, n_features,
                           rnn_hidden_size, n_classes, device)
        self.rits_b = RITS(n_steps, n_features,
                           rnn_hidden_size, n_classes, device)
