...
from libs.pypots.classification import BRITS, GRUD, Raindrop
from libs.pypots.tests.unified_data_for_test import DATA
from libs.pypots.utils.metrics import cal_binary_classification_metrics
...
class TestBRITS(unittest.TestCase):
    ...
    def test_parameters(self):
        ...
        assert hasattr(
            self.brits, "optimizer") and self.brits.optimizer is not None
...
class TestGRUD(unittest.TestCase):
    ...
    def test_parameters(self):
        ...
        assert hasattr(
            self.grud, "optimizer") and self.grud.optimizer is not None
...
class TestRaindrop(unittest.TestCase):
    ...
    def test_parameters(self):
        assert hasattr(
            self.raindrop, "model") and self.raindrop.model is not None

        assert (
            hasattr(self.raindrop,
                    "optimizer") and self.raindrop.optimizer is not None
        )
