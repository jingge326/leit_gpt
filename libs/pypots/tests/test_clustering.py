...
from libs.pypots.clustering import VaDER, CRLI
from libs.pypots.tests.unified_data_for_test import DATA
from libs.pypots.utils.metrics import cal_rand_index, cal_cluster_purity
...
class TestCRLI(unittest.TestCase):
    ...
    def test_parameters(self):
        ...
        assert hasattr(
            self.crli, "G_optimizer") and self.crli.G_optimizer is not None
        assert hasattr(
            self.crli, "D_optimizer") and self.crli.D_optimizer is not None
...
class TestVaDER(unittest.TestCase):
    ...
    def test_parameters(self):
        ...
        assert hasattr(
            self.vader, "optimizer") and self.vader.optimizer is not None
