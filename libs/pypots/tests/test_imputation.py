...
from libs.pypots.imputation import (
    SAITS,
    Transformer,
    BRITS,
    LOCF,
...
from libs.pypots.utils.metrics import cal_mae
...
class TestSAITS(unittest.TestCase):
    ...
    def test_parameters(self):
        ...
        assert hasattr(
            self.saits, "optimizer") and self.saits.optimizer is not None
    ...
    def test_impute(self):
        ...
        test_MAE = cal_mae(imputed_X, self.test_X_intact,
                           self.test_X_indicating_mask)
...
class TestTransformer(unittest.TestCase):
    ...
    def test_parameters(self):
        assert hasattr(self.transformer,
                       "model") and self.transformer.model is not None
...
class TestBRITS(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.brits = BRITS(
            DATA["n_steps"], DATA["n_features"], 256, epochs=EPOCH)
